        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Testimoni</h3>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Testimoni List</h4>
                                <a href="{{ route('testimoni.create') }}" class="btn btn-primary mt-1">Tambah Testimoni</a>
                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered text-inputs-searching default-table">
                                        ...
                                        <tbody>
                                            @forelse($testimoni as $key => $testimoni_item)
                                                <tr>
                                                    <td>{{ $testimoni_item->nama ?? '' }}</td>
                                                    <td><img src="{{ url(Storage::url($testimoni_item->photo)) }}"
                                                            alt="" width="100px"
                                                            style="border-radius:100%; object:fit;" height="100px">
                                                    </td>
                                                    <td>{!! $testimoni_item->ulasan !!}</td>
                                                    <td class="text-center">
                                                        <div class="btn-group mr-1 mb-1">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                {{-- @can('admin_access') --}}
                                                                <form
                                                                    action="{{ route('testimoni.destroy', $testimoni_item->id) }}"
                                                                    method="POST"
