                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('produk.create') }}" class="btn btn-primary mt-1">Tambah Produk</a>
                                    ...
                                    <table class="table table-striped table-bordered text-inputs-searching default-table">
                                        ...
                                        <tbody>
                                            @forelse($product as $key => $product_item)
                                                <tr>
                                                    <td>{{ $product_item->nama_produk ?? '' }}</td>
                                                    <td>{{ 'IDR ' . number_format($product_item->harga) ?? '' }}
                                                    </td>
                                                    <td><a href="{{ $product_item->link_tokped }}">Link Tokped</a></td>
                                                    <td><a href="{{ $product_item->link_tokped }}">Link Shopee</a></td>
                                                    <td class="text-center">
                                                        <div class="btn-group mr-1 mb-1">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                {{-- @can('admin_access') --}}
                                                                <form
                                                                    action="{{ route('produk.destroy', $product_item->id) }}"
                                                                    method="POST"
